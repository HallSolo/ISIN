 ...
 */
function isin_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'isin_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.isin-front-page) .entry-title,
...
.colors-custom .isin-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.isin-front-page .panel-content .recent-posts article,
...
.colors-custom.isin-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'isin_custom_colors_css', $css, $hue, $saturation );
}
